...
public class Constant {
    ...
    public static final String BROADCAST_CHANGE_REPEAT= "BROADCAST_CHANGE_REPEAT";
    ...
    public static final String BROADCAST_UPDATE_AREA_LOAD= "BROADCAST_UPDATE_AREA_LOAD";

    public static final String EXTRA_DATA= "EXTRA_DATA";
    public static final String PATH_LOAD= "PATH_LOAD";
